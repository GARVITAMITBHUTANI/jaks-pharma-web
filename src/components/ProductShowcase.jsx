...
const ProductShowcase = () => {
  ...
  return (
    <section id="products" className="py-24 bg-[#EAF2F8]/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 reveal">
          ...
          <p className="text-lg text-[#6B7280] max-w-2xl mx-auto">
            Scientifically proven formulations designed for optimal dermatological health and efficacy.
          </p>
        </div>
            ...
            <button
              ...
              className={`px-6 py-2.5 rounded-full text-sm font-medium transition-all duration-300 ${
                activeCategory === category 
                  ...
                  : 'bg-white text-gray-600 border border-gray-200 hover:bg-[#EAF2F8] hover:text-[#00529B]'
              }`}
            >
              {category}
            </button>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 reveal">
          {filteredProducts.map((product, index) => (
            ...
            >
              <div className="relative aspect-square p-6 bg-gradient-to-br from-[#EAF2F8] to-white flex items-center justify-center">
                <img 
                  src={product.image || 'https://images.unsplash.com/photo-1611078716333-e91807d4b0f9?q=80&w=600&auto=format&fit=crop'} 
                  alt={product.name}
                  className={`w-3/4 h-3/4 object-contain mix-blend-multiply group-hover:scale-105 transition-transform duration-500 ${!product.image ? 'opacity-30 mix-blend-luminosity' : ''}`}
                />
                {!product.image && (
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <p className="text-sm text-[#475569] mb-4 line-clamp-2">Premium dermatological solution by Jaks Pharma.</p>
                <div className="mt-auto flex items-center text-sm font-semibold text-[#00529B] group-hover:text-[#F37021] transition-colors">
                  Know More
        ...
        <div className="text-center mt-16 reveal">
          <button onClick={() => alert("Please upload the catalog PDF file to the public folder to enable downloads.")} className="inline-flex justify-center items-center px-8 py-3.5 border-2 border-[#00529B] text-base font-semibold rounded-full text-[#00529B] bg-transparent hover:bg-[#00529B] hover:text-white transition-all duration-300 cursor-pointer">
